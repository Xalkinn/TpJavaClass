...
public class Segment extends Figure {
	...
	public Segment(Point debut, int longueur, boolean horizontale) {
		...
		if(horizontale)
		{
			...
			//Définition du point sur l'axe des abscisse. En gros pour le point de fin nous partons du point de début et faisans la longueur pour avoir le point de fin
		}
		else
		{
			fin = new Point (debut.getX(), debut.getY()+longueur);
			//Même principe que au dessus sauf qu'ici le point est défini sur l'axe des ordonnee
		}
